 ...
 */
export function WorkflowFiles({ files }: { files: GeneratedFile[] }) {
          ...
          {files.map((f, i) => {
            ...
            return (
              <button
                ...
                onClick={() => setActive(i)}
                className={`inline-flex items-center gap-2 rounded-lg px-3.5 py-2 font-mono text-[12px] transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/50 motion-reduce:transition-none ${
